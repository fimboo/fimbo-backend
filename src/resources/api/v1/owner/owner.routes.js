...
router.patch("/update/profile",upload.single('profilePicture'),profileController.editProfile)
router.get("/view/profile/:id",profileController.viewProfile)
router.get("/profile/me",profileController.me)
router.get("/profile/all", profileController.allProfile)
router.post("/profile/rememberMe/:state",profileController.rememberProfile)
